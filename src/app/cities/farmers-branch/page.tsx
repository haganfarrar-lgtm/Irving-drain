...
export const metadata = generateSEO({
  title: 'Drainage & French Drain Services in Irving, TX | Professional Drainage Solutions',
  description: 'Expert drainage services in Irving, TX. Professional property protection, hardscaping, irrigation, and outdoor design. Free estimates.',
  keywords: ['drainage Irving', 'drainage solutions Irving', 'drainage specialist Irving', 'Texas drainage'],
  canonical: 'https://irvingdrainagepros.com/cities/irving'
})

export default function HaltomCityPage() {
  return (
    <div className="min-h-screen pt-[72px]">
      <Hero 
        title="Drainage Solutions in Irving, TX"
        subtitle="Your trusted local drainage specialist serving Irving and surrounding areas. Professional property protection, hardscaping, and design services."
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="heading-2 mt-3 mb-6">Expert Drainage for Irving Homeowners</h2>
              <p className="text-p mb-8">
                Are you looking for a professional drainage specialist in Irving, TX? Irving Drainage Pros is proud to extend our expert services to the Irving community. We understand the local climate and soil conditions, allowing us to create and maintain beautiful landscapes that thrive in North Texas.
              </p>
              
              <div className="space-y-4 mb-10">
                {[
                  'Customized designs for Irving properties',
              ...
              <Link href="/contact" className="btn-primary inline-block">
                Free Estimate for Irving Residents
              </Link>
            </div>
            ...
            <div className="relative">
              <div className="aspect-[4/3] relative rounded-3xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt="Drainage Solutions in Irving"
                  fill
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-2xl shadow-xl border border-stone-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-stone-500 font-bold uppercase tracking-widest">In Irving Area</div>
                  </div>
                </div>
              </div>
            </div>
