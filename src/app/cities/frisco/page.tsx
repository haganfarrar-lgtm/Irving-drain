...
export const metadata = generateSEO({
  title: 'Drainage & French Drain Services in Frisco, TX | Professional Drainage Solutions',
  description: 'Expert drainage services in Frisco, TX. Professional property protection, hardscaping, irrigation, and outdoor design. Free estimates.',
  keywords: ['drainage Frisco', 'drainage solutions Frisco', 'drainage specialist Frisco', 'Texas drainage'],
  canonical: 'https://irvingdrainagepros.com/cities/frisco'
})
...
export default function FriscoPage() {
  return (
    <div className="min-h-screen pt-[72px]">
      <Hero 
        title="Drainage Solutions in Frisco, TX"
        subtitle="Your trusted local drainage specialist serving Frisco and surrounding areas. Professional property protection, hardscaping, and design services."
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-stone-500 text-sm">Serving Frisco</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-forest-100 rounded-xl flex items-center justify-center shrink-0">
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="heading-2 mt-3 mb-6">Expert Drainage for Frisco Homeowners</h2>
              <p className="text-p mb-8">
                Are you looking for a professional drainage specialist in Frisco, TX? Irving Drainage Pros is proud to extend our expert services to the Frisco community. We understand the local climate and soil conditions, allowing us to create and maintain beautiful landscapes that thrive in North Texas.
              </p>
              
              <div className="space-y-4 mb-10">
                {[
                  'Customized designs for Frisco properties',
              ...
              <Link href="/contact" className="btn-primary inline-block">
                Free Estimate for Frisco Residents
              </Link>
            </div>
            ...
            <div className="relative">
              <div className="aspect-[4/3] relative rounded-3xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt="Drainage Solutions in Frisco"
                  fill
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-2xl shadow-xl border border-stone-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-stone-500 font-bold uppercase tracking-widest">In Frisco Area</div>
                  </div>
                </div>
              </div>
            </div>
