...
export const metadata = generateSEO({
  title: 'French Drain Installation Services | Professional Drainage Services in Irving',
  description: 'Effective French drain systems to manage groundwater and prevent flooding. Expert installation and design in Irving and surrounding areas.',
  keywords: ['french drain installation', 'drainage', 'Irving', 'Texas'],
  canonical: 'https://irvingdrainagepros.com/services/french-drain',
  structuredData: generateServiceSchema('French Drain Installation', 'Effective French drain systems to manage groundwater and prevent flooding.')
})

export default function FrenchDrainPage() {
  return (
    <div className="min-h-screen pt-[72px]">
      <Hero 
        title="French Drain Installation"
        subtitle="Effective French drain systems to manage groundwater and prevent flooding. We provide high-quality french drain installation solutions for residential and commercial properties in Irving."
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <div className="aspect-[4/3] relative rounded-3xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt="French Drain Installation Services"
                  fill
            ...
            <div>
              <span className="text-forest-600 font-bold uppercase tracking-widest text-sm">Specialized Expertise</span>
              <h2 className="heading-2 mt-3 mb-6">Expert French Drain Installation Solutions</h2>
              <p className="text-p mb-8">
                At Irving Drainage Pros, we take pride in delivering meticulous french drain installation services that transform and protect your property. Our experienced team uses only the highest quality materials and modern techniques to ensure lasting results.
              </p>
      ...
      <section className="section-padding bg-stone-50">
        <div className="container-custom text-center max-w-4xl mx-auto">
          <h2 className="heading-2 mb-8">Why Choose Us For Your French Drain Installation?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
            <div className="bg-white p-8 rounded-2xl border border-stone-100 shadow-sm">
              ...
              <p className="text-stone-600 leading-relaxed">
                Our team is trained to handle every aspect of french drain installation with precision. We don&apos;t cut corners and we ensure every detail is perfect.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl border border-stone-100 shadow-sm">
              <h3 className="text-xl font-bold text-stone-900 mb-4 flex items-center gap-3">
