...
export const metadata = generateSEO({
  title: 'Irrigation Systems Services | Professional Drainage Services in Irving',
  description: 'Custom irrigation systems for efficient landscape and garden watering. Expert installation and design in Irving and surrounding areas.',
  keywords: ['irrigation systems', 'drainage', 'Irving', 'Texas'],
  canonical: 'https://irvingdrainagepros.com/services/irrigation',
  structuredData: generateServiceSchema('Irrigation Systems', 'Custom irrigation systems for efficient landscape and garden watering.')
})
  ...
  return (
    <div className="min-h-screen pt-[72px]">
      <Hero 
        ...
        subtitle="Custom irrigation systems for efficient landscape and garden watering. We provide high-quality irrigation systems solutions for residential and commercial properties in Irving."
        backgroundImage="/images/services/irrigation.jpg"
      />
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <div className="aspect-[4/3] relative rounded-3xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt="Irrigation Systems Services"
                  fill
            ...
            <div>
              ...
              <h2 className="heading-2 mt-3 mb-6">Expert Irrigation Systems Solutions</h2>
              <p className="text-p mb-8">
                At Irving Drainage Pros, we take pride in delivering meticulous irrigation systems services that transform and protect your property. Our experienced team uses only the highest quality materials and modern techniques to ensure lasting results.
              </p>
      ...
      <section className="section-padding bg-stone-50">
        <div className="container-custom text-center max-w-4xl mx-auto">
          <h2 className="heading-2 mb-8">Why Choose Us For Your Irrigation Systems?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
            <div className="bg-white p-8 rounded-2xl border border-stone-100 shadow-sm">
              ...
              <p className="text-stone-600 leading-relaxed">
                Our team is trained to handle every aspect of irrigation systems with precision. We don&apos;t cut corners and we ensure every detail is perfect.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl border border-stone-100 shadow-sm">
              <h3 className="text-xl font-bold text-stone-900 mb-4 flex items-center gap-3">
